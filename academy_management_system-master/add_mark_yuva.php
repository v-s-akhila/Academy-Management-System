...
<html>
	...
	<?php
		...
		where exam_name='$exam' and exam_type='$exam_type' and exam_date_time>='$exam_date'and exam_notifications.batch='YUVAKERALA' and exam_notifications.course='$course'";
                ...
                <?php
                        ...
                        if(mysqli_num_rows($result)>0)
                        {
                            while($row1=mysqli_fetch_assoc($result))
                            {
								...
								$_SESSION['sid']=$row1['enrollment_id'];
                            }
                        }
					}
                ?>
